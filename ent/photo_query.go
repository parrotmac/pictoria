...
func (pq *PhotoQuery) QueryUploader() *UserQuery {
...
func (pq *PhotoQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (pq *PhotoQuery) Clone() *PhotoQuery {
	...
	return &PhotoQuery{
		...
		withUploader: pq.withUploader.Clone(),
...
func (pq *PhotoQuery) WithUploader(opts ...func(*UserQuery)) *PhotoQuery {
	query := (&UserClient{config: pq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	pq.withUploader = query
	return pq
}
...
//
//	client.Photo.Query().
//		GroupBy(photo.FieldOriginalName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Photo.Query().
//		Select(photo.FieldOriginalName).
//		Scan(ctx, &v)
...
func (pq *PhotoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Photo, error) {
	...
	if query := pq.withUploader; query != nil {
		if err := pq.loadUploader(ctx, query, nodes, nil,
			func(n *Photo, e *User) { n.Edges.Uploader = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PhotoQuery) loadUploader(ctx context.Context, query *UserQuery, nodes []*Photo, init func(*Photo), assign func(*Photo, *User)) error {
...
func (pq *PhotoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(photo.Table, photo.Columns, sqlgraph.NewFieldSpec(photo.FieldID, field.TypeUUID))
	_spec.From = pq.sql
